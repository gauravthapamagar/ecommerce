...
const Cart = () => {
    ...
    const {products, currency, cartItems, removeFromCart, getCartItemCount, updateCartItem, navigate, getCartTotalAmount} = useAppContext();
    const [cartArray, setCartArray] = useState([]);
    const [addresses, setAddresses] = useState(dummyAddress);
    const [selectedAddresss, setSelectedAddress] = useState(dummyAddress[0])
            ...
            <div className="max-w-[360px] w-full bg-gray-100/40 p-5 max-md:mt-16 border border-gray-300/70">
                ...
                <div className="mb-6">
                    ...
                    <div className="relative flex justify-between items-start mt-2">
                        <p className="text-gray-500">{selectedAddresss ? `${selectedAddresss.street}, ${selectedAddresss.state}, ${selectedAddresss.city}, ${selectedAddresss.country}` : "No address found"}</p>
