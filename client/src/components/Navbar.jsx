...
const Navbar = () => {
    ...
    const {user, setUser, setShowUserLogin, navigate, searchQuery, setSearchQuery, getCartItemCount} = useAppContext()
    ...
    //whenever search query runs it will execute this function
    useEffect(()=> {
